...
export default function CancelarEmailsPage() {
        ...
        {status === 'success' && (
          <div className="py-6">
            ...
            <p className="text-gray-400 text-sm">
              Não vais receber mais emails promocionais da FaçoPorTi. Continuas a receber emails relacionados com pedidos de orçamento que faças.
            </p>
          </div>
        )}
