      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p>Para questões sobre cookies, contacte-nos em <a href="mailto:contacto@façoporti.com" className="text-indigo-400 hover:underline">contacto@façoporti.com</a>.</p>
          </section>
