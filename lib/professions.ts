...
export const PROFESSIONS: Record<string, ProfessionConfig> = {
  Pintura: {
    ...
    questions: [
      ...
      { key: 'madeiras_acabamento', text: 'Acabamento pretendido?', type: 'choice', options: ['Esmalte brilhante', 'Esmalte acetinado', 'Esmalte mate', 'Sem preferência'], showIf: { key: 'subtipo_pintura', value: ['Pintura de madeiras (portas, armários...)', 'Ambos (paredes e madeiras)'] } },
